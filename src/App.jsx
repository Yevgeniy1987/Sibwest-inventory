  ...
  return (
    <main>
      <div className="container flex flex-col gap-3">
        ...
        <ItemForm locations={locations} items={items} setItems={setItems} setHistories={setHistories}/>

        <div className="">
          <InventoryMainTable items={items} locations={locations} setItems={setItems} />
        </div>
        <div>
